package com.dango.dangoaicodeapp.domain.codegen.workflow.stream;
 ...
 *             请改用 {@link com.dango.dangoaicodeapp.domain.codegen.workflow.state.WorkflowContext#emit(String)} 方法。
